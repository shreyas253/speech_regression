...
if strcmp(op.cov_Type,'Full')
    ...
    post.m = (xkBarProdNk + repmat(prior.beta0,D,1).*prior.m0) ...
    ...
    for k=1:K
      ...
      xkBarMinusm0 = xkBar(:,k) - prior.m0(:,k); %D*1
      post.invW{k} =  invW0 + SkProdNk ...
          + Nk(k)*prior.beta0(k)*(xkBarMinusm0*xkBarMinusm0')/(post.beta(k)); % D*D
